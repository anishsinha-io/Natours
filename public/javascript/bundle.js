...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5pc2hzaW5oYSIsImEiOiJja3FjdW83YmUwcmpxMnZwOWJ1bDFkMGMyIn0.cJ4llNaR7kMvKrfRwfEIpA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out! Check your network connection and try again!');
...
var stripe = Stripe('pk_test_51J7szLLdfwfgNXuj1FsUV7f6nbeVIkkggNQ2jhpGD60U5ex8VyfKckx8noy2V0zkxnXv6tkqFtYYFhX6WLrAbhUG00kjuHgEFt');
...
var loginForm = document.querySelector('.form--login'); // const email = document.getElementById('email').value;
